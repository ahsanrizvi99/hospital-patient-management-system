...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO Nurse (FirstName, LastName, Street, City, State, ZipCode, DepartmentID)
            VALUES ('$fname', '$lname', '$street', '$city', '$state', '$zip', '$dept')";

    if (mysqli_query($conn, $sql)) {
        echo "<div class='alert alert-success mt-3'>✅ Nurse registered successfully!</div>";
    } else {
